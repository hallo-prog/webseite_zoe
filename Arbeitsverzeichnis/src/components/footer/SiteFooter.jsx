...
function FooterMegaPanel({ title, kpi, links }) {
  ...
  return (
    <div className="group">
      ...
      >
        <span>{title}</span>
        <span className="md:hidden ml-2 text-neutral-400 group-hover:text-neutral-600">{open ? '−' : '+'}</span>
      </button>
    ...
    <footer className="border-t border-neutral-200 bg-white/95 backdrop-blur-sm section-warm" role="contentinfo">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        <div className="grid gap-10 lg:gap-14 md:grid-cols-5">
          <div className="md:col-span-2 flex flex-col gap-5">
            ...
            <div className="flex gap-3 pt-1">
              <a href="#" aria-label="LinkedIn" className="social-icon"><Linkedin className="w-4 h-4"/></a>
              <a href="#" aria-label="Twitter" className="social-icon"><Twitter className="w-4 h-4"/></a>
              <a href="#" aria-label="Instagram" className="social-icon"><Instagram className="w-4 h-4"/></a>
              <a href="#" aria-label="Facebook" className="social-icon"><Facebook className="w-4 h-4"/></a>
            </div>
          </div>
        ...
        <div className="mt-14 pt-8 border-t border-neutral-200 flex flex-col md:flex-row gap-6 md:items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <a href="tel:+49301234567" onClick={()=>trackFooter('Telefon')} className="nav-item border border-neutral-300">030 1234567</a>
